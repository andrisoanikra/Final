...
// Minimal, reliable base URL for production:
// - If you set BASE_URL (or APP_BASE_URL) in the environment, we use it.
// - Otherwise we fall back to the directory portion of SCRIPT_NAME.
// This is small and safe to deploy and makes templates using <?= $base  work when the app is served from a sub-path.
$envBase = getenv('BASE_URL');
if ($envBase === false || $envBase === null || $envBase === '') {
