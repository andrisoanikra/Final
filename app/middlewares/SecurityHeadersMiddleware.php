...
class SecurityHeadersMiddleware
{
	...
	public function before(array $params): void
	{
		...
		$csp = "default-src 'self'; script-src 'self' 'nonce-{$nonce}' 'strict-dynamic' https://cdn.jsdelivr.net; style-src 'self' {$tracyCssBypass} https://fonts.googleapis.com https://cdn.jsdelivr.net; font-src 'self' https://fonts.gstatic.com; img-src 'self' data:;";
